...
class LongestJourneyInTests {
    ...
    @Test
    void returns_empty_list_for_empty_list() {
        assertEquals(
            emptyList(),
    ...
    @Test
    void returns_empty_list_for_0_limit() {
        assertEquals(
            emptyList(),
    ...
    @Test
    void returns_up_to_limit_results() {
        assertEquals(
            List.of(longJourney, mediumJourney, shortJourney),
